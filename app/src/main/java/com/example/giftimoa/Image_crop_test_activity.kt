...
class Image_crop_test_activity : AppCompatActivity() {
    var image //사용되는 이미지
            : Bitmap? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.image_crop_test)
        OCRTextView = findViewById(R.id.OCRTextView)

        //이미지 디코딩을 위한 초기화
        image = BitmapFactory.decodeResource(resources, R.drawable.image_test4) //샘플이미지파일
